...
class Kauppa:
    def __init__(self, varasto_instanssi=varasto, 
        pankki_instanssi=pankki, 
        viite_instanssi=viitegeneraattori):

        self._varasto = varasto_instanssi
        self._pankki = pankki_instanssi
        self._viitegeneraattori = viite_instanssi
