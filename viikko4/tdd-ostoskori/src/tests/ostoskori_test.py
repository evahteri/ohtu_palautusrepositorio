...
class TestOstoskori(unittest.TestCase):
    ...
    def test_tavaroiden_lukumäärä_kaksi_eri_tuotetta(self):
        maito = Tuote("Maito", 3)
        leipä = Tuote("Leipä", 5)
        self.kori.lisaa_tuote(maito)
    ...
    def test_kahden_eri_tuotteen_lisäämisen_jälkeen_hinta_oikein(self):
        maito = Tuote("Maito", 3)
        leipä = Tuote("Leipä", 5)
        self.kori.lisaa_tuote(maito)
        self.kori.lisaa_tuote(leipä)
    ...
    def test_kahden_saman_tuotteen_lisäämisen_jälkeen_hinta_oikein(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.lisaa_tuote(maito)
    ...
    def test_kahden_saman_tuotteen_lisaamisen_jalkeen_korissa_yksi_ostosolio_jolla_oikeat_tiedot(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.lisaa_tuote(maito)
        ...
        self.assertEqual((ostokset[0].tuotteen_nimi(), ostokset[0].lukumaara()), ("Maito", 2))
    ...
    def test_tuote_lisataan_ja_poistetaa_onko_ostoskori_tyhja(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.poista_tuote(maito)
